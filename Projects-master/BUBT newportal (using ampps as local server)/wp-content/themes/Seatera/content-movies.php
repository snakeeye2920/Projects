		...
		<div class="main_top">
			...
			<div class="event_main_side">
				...
				<div class="overview-container">
					<div class="main_side_left">
						...
						foreach ($categories as $value) {
							...
							<?php if ( get_post_meta( get_the_ID(), 'event_country', true ) != '' ) { ?>
								<div class="event_list_item icon-globe"><div class="title left"><?php _e('Country:','vh'); ?></div><div class="info event_country"><?php echo get_post_meta( get_the_ID(), 'event_country', true ); ?></div><div class="clearfix"></div></div>
							<?php } ?>
							...
							<?php if ( $categories_string != '' ) { ?>
								<div class="event_list_item icon-tags"><div class="title left"><?php _e('Category:','vh'); ?></div><div class="info event_category"><?php echo $categories_string; ?></div><div class="clearfix"></div></div>
							<?php } ?>
							<?php if ( get_post_meta( get_the_ID(), 'event_release', true ) != '' ) { ?>
								<div class="event_list_item icon-calendar"><div class="title left"><?php _e('Release date:','vh'); ?></div><div class="info event_release"><?php echo get_post_meta( get_the_ID(), 'event_release', true ); ?></div><div class="clearfix"></div></div>
							<?php } ?>
					...
					<div class="main_side_right">
							<?php if ( get_post_meta( get_the_ID(), 'event_director', true ) != '' ) { ?>
								<div class="event_list_item icon-user"><div class="title right"><?php _e('Director:','vh'); ?></div><div class="info event_director"><?php echo get_post_meta( get_the_ID(), 'event_director', true ); ?></div><div class="clearfix"></div></div>
							<?php } ?>
							...
							<?php if ( get_post_meta( get_the_ID(), 'event_box_office', true ) != '' ) { ?>
								<div class="event_list_item icon-dollar"><div class="title right"><?php _e('Box Office:','vh'); ?></div><div class="info event_box_office"><?php echo get_post_meta( get_the_ID(), 'event_box_office', true ); ?></div><div class="clearfix"></div></div>
							<?php } ?>
				...
				<div class="event_buttons">
					<div class="button_red"><a href="#" class="vh_button red icon-ticket hover_right"><?php _e('Buy tickets','vh'); ?></a></div>
					<?php
					...
					if ( $youtube[0] != '' ) {
						...
						<div class="button_yellow"><a href="#" class="vh_button yellow icon-play-1 hover_right"><?php _e('Watch trailer','vh'); ?></a><input type="hidden" value="<?php echo $youtube_url; ?>"></input></div>
					<?php } ?>
				</div>
			</div>
