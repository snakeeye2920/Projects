...
$offer_categories = array(__('Choose a category', 'vh'));
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"holder" => "div",
			"class" => "",
			"heading" => __("Movies per page", "vh" ),
			"param_name" => "movies_list_per_page",
			"value" => "",
			"description" => __("How many movies to show per page.", "vh" )
			),
		array(
			"type" => "checkbox",
			"holder" => "div",
