...
class vh_googlemap extends WP_Widget {
	public function vh_googlemap() {
		...
		parent::__construct('gmap', __('Seatera - Google map', 'vh') , $widget_options);
	}
	...
	public function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address:', 'vh'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>" type="text" value="<?php echo $address; ?>" />
			<small><?php _e('Choose an address or latitute and logtitude', 'vh')?></small>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('latitude'); ?>"><?php _e('Latitude:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('longitude'); ?>"><?php _e('Longitude:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('zoom'); ?>"><?php _e('Zoom level:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('html'); ?>"><?php _e('Content for the marker:', 'vh'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('popup'); ?>"><?php _e('Auto popup the info?', 'vh'); ?></label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Height:', 'vh'); ?></label>
