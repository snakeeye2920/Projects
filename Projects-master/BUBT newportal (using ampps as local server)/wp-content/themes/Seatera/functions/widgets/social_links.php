...
class SocialMediaWidget extends WP_Widget {
	...
	function SocialMediaWidget() {
		$widget_ops = array(
			...
			'description' => __('Link to your RSS feed and social media accounts.', 'vh')
		);
		parent::__construct('social_networks', __('Seatera - Social Network links', 'vh'), $widget_ops);
	}
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('rss'); ?>"><?php _e('RSS URL: (leave empty for default feed)', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e('Facebook URL:', 'vh'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('facebook'); ?>" name="<?php echo $this->get_field_name('facebook'); ?>" type="text" value="<?php echo esc_attr($facebook); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e('Twitter URL:', 'vh'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('twitter'); ?>" name="<?php echo $this->get_field_name('twitter'); ?>" type="text" value="<?php echo esc_attr($twitter); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('flickr'); ?>"><?php _e('Flickr URL:', 'vh'); ?></label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id('youtube'); ?>"><?php _e('Youtube URL:', 'vh'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('youtube'); ?>" name="<?php echo $this->get_field_name('youtube'); ?>" type="text" value="<?php echo esc_attr($youtube); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('linkedin'); ?>"><?php _e('LinkedIn URL:', 'vh'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('linkedin'); ?>" name="<?php echo $this->get_field_name('linkedin'); ?>" type="text" value="<?php echo esc_attr($linkedin); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('foursquare'); ?>"><?php _e('FourSquare URL:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('delicious'); ?>"><?php _e('Delicious URL:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('digg'); ?>"><?php _e('Digg URL:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('skype'); ?>"><?php _e('Skype URL:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('tumblr'); ?>"><?php _e('Tumblr URL:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('vimeo'); ?>"><?php _e('Vimeo URL:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('instagram'); ?>"><?php _e('Instagram URL:', 'vh'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('instagram'); ?>" name="<?php echo $this->get_field_name('instagram'); ?>" type="text" value="<?php echo esc_attr($instagram); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('pintrest'); ?>"><?php _e('Pintrest URL:', 'vh'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('google'); ?>"><?php _e('Google+ URL:', 'vh'); ?></label>
