...
$css_class = 'vc_row wpb_row wpb_teaser_grid wpb_content_element '.
    ...
    <div class="wpb_wrapper">
        ...
        <div class="teaser_grid_container">
            ...
            <ul class="categories_filter vc_clearfix">
                <li class="active"><a href="#" data-filter="*"><?php _e('All', 'vh') ?></a></li>
            ...
            <ul class="wpb_thumbnails wpb_thumbnails-fluid vc_clearfix" data-layout-mode="<?php echo $grid_layout_mode ?>">
                ...
                <?php endforeach; ?>
                <?php else: ?>
                <li class="<?php echo $this->spanClass(1); ?>"><?php _e("Nothing found." , "vh") ?></li>
                <?php endif; ?>
            </ul>
        </div>
