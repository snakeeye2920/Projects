...
// Footer copyright
$copyrights = get_option('vh_footer_copyright') ? get_option('vh_footer_copyright') : '&copy; [year], Shared by <a href="http://www.watchop.online/">Themekiller.com</a>';
...
?>
		...
		<div class="footer-wrapper">
			<div class="footer-container vc_row wpb_row vc_row-fluid <?php if ( !is_home() && !is_front_page() ) { echo 'not_front_page';}?>">
