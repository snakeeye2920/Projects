...
$form->addElement(new Element_Textbox(RM_UI_Strings::get('LABEL_USERNAME'), "username", array("required" => "1","placeholder"=>RM_UI_Strings::get('LABEL_USERNAME_PH'))));
$form->addElement(new Element_Password(RM_UI_Strings::get('LABEL_PASSWORD'), "password",array("required"=>1,"placeholder"=>RM_UI_Strings::get('LABEL_PASSWORD_PH'))));
