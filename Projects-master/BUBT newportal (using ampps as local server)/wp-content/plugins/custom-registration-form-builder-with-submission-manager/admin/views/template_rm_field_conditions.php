...
<script type="text/javascript">
    ...
    { 
        ...
        var html = '<div class="rm-field-condition-row"><div class="rm-controlling-atr"><div class="rminput"><select name="cfields[]"><option>Select Field</option><?php echo $fields_dd_options; ?></select></div></div><div class="rm-controlling-atr"><div class="rminput"><select onchange="opChanged(this)" name="op[]"><?php echo RM_Utilities::get_cond_op_dd(); ?></select></div></div><div class="rm-controlling-atr"><div class="rminput"><input type="text" name="values[]" placeholder="Value" maxlength="50"></div></div><div class="rm-controlling-atr rm-controlling-btn"> <div class="rminput"><a onclick="delete_dependency(this)" href="javascript:void(0)">Remove</a></div></div></div>';
            ...
            <div class="rm-conditional">
                <div class="rm-conditions">
                    <div class="rm-add-field" style="display:none">
                        <a href="javascript:void(0)" onclick="addField()">Add</a>
                        ...
                        <div style="<?php echo $display; ?>" class="rm-condition" id="rm_condition_<?php echo $field->field_id; ?>"> 
                                ...
                                <div class="rm-field-conditions-wrap">
                                    <div class="rm-field-conditions-title">
                                        ...
                                        <div class="rm-field-conditions-delete"><a href="javascript:void(0)" onclick="delete_all(<?php echo $field->field_id; ?>)">Delete</a> </div>
                                    ...
                                    <div class="rm-match-condition-row">
                                                <div class="rm-match-condition"><input type="radio" name="combinator" value="OR" <?php echo @$options->conditions['settings']['combinator'] != 'AND' ? 'checked' : '' ?>><label for="rm-match-all-condition" >Match Any Condition</label></div>     
                                                <div class="rm-match-condition"><input  type="radio" name="combinator" value="AND" <?php echo @$options->conditions['settings']['combinator'] == 'AND' ? 'checked' : '' ?>><label for="rm-match-one-condition" >Match All Conditions</label></div> 
                                    </div>
                                    <?php
                                    ...
                                    foreach ($options->conditions['rules'] as $key => $condition):
                                        ...
                                        ?>   
                                            <div class="rm-field-condition-row">
                                                ...
                                                <div class="rm-controlling-atr">
                                                    <div class="rminput">
                                                        <input type="text" class="<?php echo ($condition['op']=='_blank' || $condition['op']=='_not_blank')?'rm-block-input':''; ?>" value="<?php echo htmlspecialchars($condition['values'][0]); ?>" name="values[]" placeholder="Value"  maxlength="50" />
                                                    </div>
                                                </div>
                                   ...
                                   <div class="rm-add-condition-row">  <a onclick="addConditionForm(<?php echo $field->field_id; ?>)" href="javascript:void(0)">Add</a></div> 
                                   <div class="rm-save-condition-row"> <input type="submit" value="Save" /></div>
                                </div>
                        </div></form>
                        <?php
                    endforeach;
