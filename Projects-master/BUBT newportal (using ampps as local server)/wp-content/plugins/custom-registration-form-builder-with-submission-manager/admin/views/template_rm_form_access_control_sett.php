...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_HTMLL('&#8592; &nbsp; Cancel', '?page='.$data->next_page.'&rm_form_id='.$data->form_id, array('class' => 'cancel')));
    ...
    <?php 
    $rm_promo_banner_title = "Unlock powerful access control and more by upgrading";
