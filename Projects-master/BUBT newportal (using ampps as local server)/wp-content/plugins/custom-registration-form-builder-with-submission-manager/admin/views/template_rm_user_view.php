...
<div class="rmagic">
    ...
    <div class="rm-user-area">
        ...
        <div id="rm_popup_send_email" style="display:none">
            ...
            <div class="rm_popup_send_email_row">
                  <button class="popup-submit rm-send_email-popup-close" type="button" id="rm_popup_cancel_email_button" onclick="jQuery('#rm_popup_send_email').hide()">← &nbsp;Cancel</button>
...
function rm_send_email(email)
{
    ...
    jQuery.post(ajaxurl, data, function(){jQuery('#rm_popup_send_email').hide();alert('Email has been sent successfully.');});
}
