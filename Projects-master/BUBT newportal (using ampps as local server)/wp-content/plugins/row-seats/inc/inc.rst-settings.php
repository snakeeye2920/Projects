...
<?php 
$rstetemp = "";
if(isset($rst_options['rst_etemp']))
$rstetemp = $rst_options['rst_etemp'];

wp_editor( stripslashes($rstetemp), 'rst_etemp', $settings = array('textarea_name' => 'rst_etemp','tinymce'=>true) ); ?>
...
$rstetemp = "";
if(isset($rst_options['rst_adminetemp']))
$rstetemp = $rst_options['rst_adminetemp'];


 wp_editor( stripslashes($rstetemp), 'rst_adminetemp', $settings = array('textarea_name' => 'rst_adminetemp') ); ?>
            ...
            <tr valign="top">
                ...
                <td>
                    <input name="rst_disable_admin_email" id="rst_disable_admin_email" type="checkbox"
                           value="off" <?php  if (isset($rst_options['rst_disable_admin_email']) && $rst_options['rst_disable_admin_email'] == 'off') echo 'checked'; ?>/>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"><label
                ...
                <td>
                    <input type="text" id="rst_release_min" name="rst_release_min" class="regular-text"
                           value="<?php  if (isset($rst_options['rst_release_min'])) echo stripslashes($rst_options['rst_release_min']); ?>"/>
                </td>
            </tr>
<!--            <tr valign="top">-->
            ...
            <tr valign="top">
                ...
                <td>
                    <select name="rst_theme" id="rst_theme">
                        <option value="lite.css" <?php  if (isset($rst_options['rst_theme']) && $rst_options['rst_theme'] == 'lite.css') echo 'selected';?>>
                            Lite
                        </option>
                        <option value="dark.css" <?php  if (isset($rst_options['rst_theme']) && $rst_options['rst_theme'] == 'dark.css') echo 'selected';?>>
                            Dark
                        </option>
                        <option
                            value="lite_yellow.css" <?php  if (isset($rst_options['rst_theme']) && $rst_options['rst_theme'] == 'lite_yellow.css') echo 'selected';?>>
                            Yellow
                        </option>
                        <option
                            value="lite_purple.css" <?php  if (isset($rst_options['rst_theme']) && $rst_options['rst_theme'] == 'lite_purple.css') echo 'selected';?>>
                            Purple
                        </option>
                        <option
                            value="lite_pink.css" <?php  if (isset($rst_options['rst_theme']) && $rst_options['rst_theme'] == 'lite_pink.css') echo 'selected';?>>
                            Pink
                        </option>
                        <option
                            value="lite_gray.css" <?php  if (isset($rst_options['rst_theme']) && $rst_options['rst_theme'] == 'lite_gray.css') echo 'selected';?>>
                            Gray
                        </option>
	 ...
	 <tr valign="top">
                ...
                <td>
                    <select name="rst_zoom" id="rst_zoom">
                        <option value="1" <?php  if (isset($rst_options['rst_zoom']) && $rst_options['rst_zoom'] == '1') echo 'selected';?>>
                            100%
                        </option>
                        <option value="0.9" <?php  if (isset($rst_options['rst_zoom']) && $rst_options['rst_zoom'] == '0.9') echo 'selected';?>>
                            90%
                        </option>
                        <option value="0.8" <?php  if (isset($rst_options['rst_zoom']) && $rst_options['rst_zoom'] == '0.8') echo 'selected';?>>
                            80%
                        </option>
                        <option value="0.7" <?php  if (isset($rst_options['rst_zoom']) && $rst_options['rst_zoom'] == '0.7') echo 'selected';?>>
                            70%
                        </option>
                        <option value="0.6" <?php  if (isset($rst_options['rst_zoom']) && $rst_options['rst_zoom'] == '0.6') echo 'selected';?>>
                            60%
                        </option>
