...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	...
	$this->consumer_key = get_option( 'vh_twitter_consumer_key' );

	// Your Twitter App Consumer Secret
	$this->consumer_secret = get_option( 'vh_twitter_consumer_secret' );

	// Your Twitter App Access Token
	$this->user_token = get_option( 'vh_twitter_user_token' );

	// Your Twitter App Access Token Secret
	$this->user_secret = get_option( 'vh_twitter_user_secret' );
